...
export default function Modal({open, closeModal, children}: Props){
    ...
    return open ? (
        <div className="z-50 fixed top-0 left-0 w-screen h-screen bg-gray-500 bg-opacity-50 flex items-center justify-center">
            <div className="bg-white p-2 sm:p-4 lg:p-6 sm:rounded w-10/12 py-8 sm:py-10 lg:py-12 sm:w-5/12 lg:w-fit lg:max-w-2xl relative shadow-xl shadow-gray-900/50 pointer-events-auto">
